...
const styles = `
  ...
  * {
  ...
  .arch-node-mini span:first-child {
    font-size: 16px;
  }
          ...
          <div className="architecture-container">
            ...
            <div className="architecture-diagram">
              ...
              <div className="arch-flow-horizontal">
                ...
                {/* Terraform Cloud */}
                <div className="arch-node" style={{ borderColor: '#7B42BC' }}>
                  <span className="arch-node-icon">
                    <svg width="28" height="28" viewBox="0 0 128 128" fill="#7B42BC">
              ...
              {/* User Flow */}
              <div className="arch-flow-label">User Request Flow</div>
              <div className="arch-flow-horizontal user-flow">
                <div className="arch-node-mini">
                  <span>👤</span>
                  <span>User</span>
                </div>
                <div className="arch-arrow-h">→</div>
                <div className="arch-node-mini" style={{ borderColor: '#F38020' }}>
                ...
                <div className="arch-arrow-h">→</div>
                <div className="arch-node-mini" style={{ borderColor: '#FF9900' }}>
                ...
                <div className="arch-arrow-h">→</div>
                <div className="arch-node-mini" style={{ borderColor: '#569A31' }}>
