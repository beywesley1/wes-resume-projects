...
export const getTfModuleIcon = (module) => {
  ...
  if (module.provider === 'kubernetes') {
    return `<svg width="22" height="22" viewBox="0 0 24 24" fill="#326CE5"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 21.5c-5.238 0-9.5-4.262-9.5-9.5S6.762 2.5 12 2.5s9.5 4.262 9.5 9.5-4.262 9.5-9.5 9.5z"/></svg>`;
  }
  return '';
};
